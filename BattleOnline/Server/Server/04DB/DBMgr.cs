...
public class DBMgr
{
    ...
    public void Init()
    {
        conn = new MySqlConnection("server=localhost;user id=root;password=root;database=darkgod;charset=utf8;SslMode=none;Allow User Variables=True;");
        conn.Open();
